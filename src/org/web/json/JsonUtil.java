...
public class JsonUtil {
	...
	*/
	...
	public static boolean isJson(String str)
	{
	 ...
	 {
	    String jstr="{\"id\" : \"johncon\", \"name\" : \"小强\",\"content\":[{\"id\":695331918,\"guid\":\"b86be1ff-97c6-4779-b75b-e38a503d6ae5\"}]} ";
	    Map m=getRecursiveMapFromJson(jstr);
	    System.out.println("id:"+m.get("id"));
	    System.out.println("name:"+m.get("name"));
	    System.out.println("content.guid:"+((Map)m.get("content")).get("guid"));
	    ...
	    try{
	       ...
	       System.out.println("isJson1:"+isJson(hjstr));
	       System.out.println("isJson2:"+isJson( hm.get("keywords")));
